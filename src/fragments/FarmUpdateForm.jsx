...
export default function FarmUpdateForm(props) {
  ...
  const dv = {
    ...
    province: function () {
      return raw.farm.province || 'QUIRINO'
    },
    ...
    municipal: function () {
      return raw.farm.municipal || 'CABARROGUIS'
    },
  ...
  function selectMunicipal(e) {
    ...
    setBarangayList(() => {
      if (e.target.value === '') return []
      let p = address['02'].province_list[province]
  ...
  function submitForm(e) {
    ...
    if (request_body.region === raw.farm.region) {
      delete request_body.region
    }
    if (request_body.province === raw.farm.province) {
      delete request_body.province
    }
    if (request_body.municipal === raw.farm.municipal) {
      delete request_body.municipal
    }
    if (request_body.barangay === raw.farm.barangay) {
  ...
  React.useEffect(() => {
    setMunicipal(farm.municipal)
  }, [farm.municipal])

  React.useEffect(() => {
    setBarangay(farm.barangay)
  }, [farm.barangay])
  ...
  React.useEffect(() => {
    ...
    setBarangayList(() => {
      if (municipal === '') return []
      let p = address['02'].province_list[province]
      return p.municipality_list[municipal].barangay_list
    })
    setBarangay('')
  }, [municipal])
  ...
  return (
    <div>
      ...
      <Breadcrumbs>
        ...
        <small>Update Farm</small>
      </Breadcrumbs>
      <ScreenTitle>
        <h1>Farm Update Form</h1>
        <p>
